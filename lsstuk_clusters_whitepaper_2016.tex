...
powerful probe will be the the X-ray luminosity function of LSST clusters
and groups in this regime. This would necessitate access to raw
eROSITA photon images (plus calibration products such as exposure
maps, background maps and PSF models) in order to properly Poisson
statistics of the sparse X-ray data when inferring X-ray fluxes and
upper limits at the positions of LSST clusters.
